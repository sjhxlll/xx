...
echo ""
last_version=$(curl -Ls "https://git-mr.aidoi.de/https://api.github.com/repos/xeefei/3x-ui/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
# 获取 x-ui 版本
...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        echo ""
        sleep 2
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(arch).tar.gz https://git-mr.aidoi.de/https://github.com/xeefei/3x-ui/releases/download/${last_version}/x-ui-linux-$(arch).tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://git-mr.aidoi.de/https://github.com/xeefei/3x-ui/releases/download/${last_version}/x-ui-linux-$(arch).tar.gz"
        echo ""
        echo -e "--------------------------------------------"
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://git-mr.aidoi.de/https://raw.githubusercontent.com/xeefei/3x-ui/main/x-ui.sh
...
echo -e "----------------------------------------------"
echo ""
echo -e "${green}〔3X-UI〕优化版项目地址：${yellow}https://git-mr.aidoi.de/https://github.com/xeefei/3x-ui${plain}" 
echo ""
echo -e "${green} 详细安装教程：${yellow}https://git-mr.aidoi.de/https://xeefei.github.io/xufei/2024/05/3x-ui/${plain}"
echo ""
echo -e "----------------------------------------------"
echo ""
